from sqlalchemy import Column, ForeignKey, String, Enum, Float, DateTime, event
...
class Profile(Base):
    ...
    transportation_mode = Column(String, index=True, default=TransportationMode.DRIVING)
    rating = Column(Float, index=True, default=4.5)
